 ...
 */
abstract class GitDisposableObserver<T> constructor(private val view: BaseView) : DisposableObserver<T>() {
                ...
                when (code) {
                    ...
                    in 400..499 -> { // some thing went wrong on the client side
                        try {
                            ...
                            // convert errorString into GitWrappedError object
                            val wrappedError = Gson().fromJson(errorString, GitWrappedError::class.java)
